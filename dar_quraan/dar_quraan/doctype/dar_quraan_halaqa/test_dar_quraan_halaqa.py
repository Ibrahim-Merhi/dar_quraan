...
class TestDarQuraanHalaqa(FrappeTestCase):
    ...
    def test_create_valid_halaqa(self):
        ...
        self.assertEqual(halaqa.branch, self.branch.name)
        self.assertEqual(halaqa.teaching_location, self.location.name)
        self.assertEqual(halaqa.maximum_students, 20)
        self.assertEqual(halaqa.current_students, 0)
        self.assertEqual(halaqa.allow_new_enrollments, 1)
    ...
    def test_halaqa_code_is_normalized(self):
        ...
        self.assertEqual(halaqa.halaqa_code, code)
    ...
    def test_same_name_is_allowed_in_different_branch(self):
        ...
        self.assertNotEqual(first_halaqa.branch, second_halaqa.branch)
    ...
    def test_inactive_teaching_location_is_rejected(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_location_that_does_not_allow_halaqas_is_rejected(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_location_must_belong_to_selected_branch(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_term_must_belong_to_selected_academic_year(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_maximum_students_must_be_greater_than_zero(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_current_students_cannot_be_negative(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_current_students_cannot_exceed_capacity(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_start_date_cannot_be_after_end_date(self):
        with self.assertRaisesRegex(
            ...
            self.create_halaqa(
                ...
                start_date=add_days(self.term_start, 20),
                end_date=add_days(self.term_start, 10),
            )

    def test_start_date_cannot_be_before_term(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_end_date_cannot_be_after_term(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_same_mentor_and_assistant_is_rejected(self):
    ...
    def test_closed_halaqa_requires_closed_on(self):
        with self.assertRaisesRegex(
            frappe.ValidationError,
    ...
    def test_closed_halaqa_disables_new_enrollments(self):
        halaqa = self.create_halaqa(
        ...
        self.assertEqual(halaqa.status, "Closed")
        self.assertEqual(halaqa.allow_new_enrollments, 0)
        ...
        doc = frappe.get_doc(
            {
                ...
                "teaching_location": (
                    teaching_location or self.location.name
                ),
                "academic_year": (
                    academic_year or self.academic_year.name
                ),
                "academic_term": (
                    academic_term or self.academic_term.name
                ),
                "mentor": mentor,
