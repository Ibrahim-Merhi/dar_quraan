...
class TestQuranStateService(FrappeTestCase):
    ...
    def test_existing_state_is_returned(self):
        ...
        with (
            ...
            result = get_or_create_quran_state(
                "DQ-SA-TEST-00001"
            )
    ...
    def test_completed_progress_updates_state(self):
        ...
        with patch(
            "dar_quraan.dar_quraan.services.quran_state."
            "get_or_create_quran_state",
            return_value=state,
        ):
            result = update_state_from_progress(
                progress
            )
    ...
    def test_completed_evaluation_updates_reference(self):
        ...
        with patch(
            ...
            result = update_state_from_evaluation(
                evaluation
            )
